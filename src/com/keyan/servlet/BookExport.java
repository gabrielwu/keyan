...
import com.keyan.javabean.Book_javabean;
...
public class BookExport extends HttpServlet {

	/**
	 * 
	 */
	private static final long serialVersionUID = -3161044577259569849L;
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        sMap.put("isbn", request.getParameter("s_isbn"));
        sMap.put("press", request.getParameter("s_press"));
        ...
        sMapRange.put("date_press", request.getParameter("s_date_press"));
        sMapRange.put("date_press_2", request.getParameter("date_press_2"));

        sMapEq.put("pass", request.getParameter("s_pass"));
        sMapEq.put("words_count", request.getParameter("s_words_count"));
		...
		System.out.println("+++"+sMapEq.get("words_count"));
		Book_javabean jb = new Book_javabean();
