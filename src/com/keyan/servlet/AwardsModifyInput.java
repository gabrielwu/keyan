...
public class AwardsModifyInput extends HttpServlet {

	/**
	 * 
	 */
	private static final long serialVersionUID = -712427160004568716L;

	/**
	 * Constructor of the object.
	 */
	public AwardsModifyInput() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (data.get("pass").equals("1") && !login_type.equals("1")) {
			...
			RequestDispatcher dispatcher = request.getRequestDispatcher("/awardsModifyInput.jsp"); 
