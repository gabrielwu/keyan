...
import com.keyan.javabean.Patent_javabean;
...
public class PatentList extends HttpServlet {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1811287995723920186L;
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        sMap.put("number_apply", request.getParameter("s_number_apply"));
        sMap.put("number_public", request.getParameter("s_number_public"));
        ...
        sMapRange.put("date_apply", request.getParameter("s_date_apply"));
        sMapRange.put("date_apply_2", request.getParameter("s_date_apply_2"));
        sMapRange.put("date_public", request.getParameter("s_date_public"));
        sMapRange.put("date_public_2", request.getParameter("s_date_public_2"));
		...
		Patent_javabean jb = new Patent_javabean();
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/patentList.jsp"); 
