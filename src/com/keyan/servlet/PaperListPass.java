...
public class PaperListPass extends HttpServlet {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1439820430190174628L;

	/**
	 * Constructor of the object.
	 */
	public PaperListPass() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        sMapEq.put("area_id", request.getParameter("s_area_id"));
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/paperListPass.jsp"); 
