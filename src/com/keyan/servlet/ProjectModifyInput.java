...
public class ProjectModifyInput extends HttpServlet {

	/**
	 * 
	 */
	private static final long serialVersionUID = 2702105876635274607L;

	/**
	 * Constructor of the object.
	 */
	public ProjectModifyInput() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        //Map<String, String> dataOri = (Map<String, String>) map.get("data");
        //String[] costYears = dataOri.get("costYears").split(","); 
        Map<String, Object> data = (Map<String, Object>) map.get("data");
        //data.remove("costYears");
        //data.put("costYears", costYears);
        ArrayList<Map<String, Object>> members = (ArrayList<Map<String, Object>>) map.get("members");
		// 类型列表
		...
		if (data.get("pass").equals("1") && !login_type.equals("1")) {
			...
			// 跳转jsp
			RequestDispatcher dispatcher = request.getRequestDispatcher("/projectModifyInput.jsp"); 
