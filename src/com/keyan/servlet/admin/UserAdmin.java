...
public class UserAdmin extends HttpServlet {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2964235936116122993L;
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		ArrayList<Map<String, String>> dataList = ujb.getUserAdminList();
		request.setAttribute("dataList", dataList);
		request.setAttribute("labList", labList);
		RequestDispatcher dispatcher = request.getRequestDispatcher("/admin/userAdmin.jsp"); 
