...
public class PaperView extends HttpServlet {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 3417082160761291207L;
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		Map<String, Object> map = jb.viewPaper();
        Map<String, String> data = (Map<String, String>) map.get("data");
        ArrayList<Map<String, String>> members = (ArrayList<Map<String, String>>) map.get("members");
		request.setAttribute("data", data);
		request.setAttribute("members", members);
		RequestDispatcher dispatcher = request.getRequestDispatcher("/paperView.jsp"); 
