...
public class PatentModifyInput extends HttpServlet {

	/**
	 * 
	 */
	private static final long serialVersionUID = -6438799083525986135L;

	/**
	 * Constructor of the object.
	 */
	public PatentModifyInput() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (data.get("pass").equals("1") && !login_type.equals("1")) {
			...
			// 跳转jsp
			RequestDispatcher dispatcher = request.getRequestDispatcher("/patentModifyInput.jsp"); 
