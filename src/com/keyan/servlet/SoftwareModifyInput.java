...
public class SoftwareModifyInput extends HttpServlet {

	/**
	 * 
	 */
	private static final long serialVersionUID = 431078339548885413L;

	/**
	 * Constructor of the object.
	 */
	public SoftwareModifyInput() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (data.get("pass").equals("1") && !login_type.equals("1")) {
			...
			// 跳转jsp
			RequestDispatcher dispatcher = request.getRequestDispatcher("/softwareModifyInput.jsp"); 
