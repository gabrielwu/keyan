...
public class Software_javabean {
	private String table_name;
	private String table;
	public Software_javabean() {
		this.table_name = "r_software";
		this.table = "6";
	}
	// TODO
	public ArrayList<Map<String, String>> getList() {
    	...
    	String sql = "select a.isAwarded, a.id,a.leader_id, a.title, a.pass, a.number,a.date_publish,  substring(a.date_commit, 1, 10) as date_commit, u.name, t.name as type " +
    ...
    public ArrayList<Map<String, String>> getList(String user_id){
		Calendar cal = Calendar.getInstance(); 
		int currentYear = cal.get(Calendar.YEAR);
    	String sql = "select a.isAwarded, a.id,a.leader_id, a.title, a.pass, a.number,a.date_publish,  " +
	...
	public ArrayList<Map<String, String>> getList(
    	...
    	String sql = "";
    	String sqlC = "select a.isAwarded, a.id,a.leader_id, a.title, a.pass, a.number,a.date_publish, " +
    			"substring(a.date_commit, 1, 10) as date_commit, u.name, t.name as type ";
    	...
    	String date_authorized = mapRange.get("date_authorized");
    	String date_authorized_2 = mapRange.get("date_authorized_2");
		...
		if (date_authorized != null && !date_authorized.equals("")) {
			sqlW2 += "and date_authorized>='"+date_authorized+"' ";
		}
		...
		if (date_authorized_2 != null && !date_authorized_2.equals("")) {
			sqlW2 += "and date_authorized<='"+date_authorized_2+"' ";
		}
