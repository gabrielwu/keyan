...
public class Awards_javabean {
	private String table_name;
	private String table;
	public Awards_javabean() {
		this.table_name = "r_awards";
		this.table = "4";
	}
	// TODO
	public ArrayList<Map<String, String>> getList() {
    	...
    	String sql = "select a.isAwarded, a.id, a.number,a.leader_id, a.title, a.pass, a.level,a.date, a.department,  substring(a.date_commit, 1, 10) as date_commit, u.name, t.name as type " +
    ...
    public ArrayList<Map<String, String>> getList(String user_id){
		Calendar cal = Calendar.getInstance(); 
		int currentYear = cal.get(Calendar.YEAR);
    	String sql = "select a.isAwarded, a.id, a.number,a.leader_id, a.title, a.pass, a.level,a.date, a.department,  " +
	...
	public ArrayList<Map<String, String>> getList(
    	...
    	String sql = "";
    	String sqlC = "select a.isAwarded, a.id, a.number,a.leader_id, a.title, a.pass, a.level,a.date, a.department, " +
    			"substring(a.date_commit, 1, 10) as date_commit, u.name, t.name as type ";
    	...
    	String date = mapRange.get("date");
    	String date_2 = mapRange.get("date_2");
