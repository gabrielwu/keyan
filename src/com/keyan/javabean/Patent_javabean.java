...
public class Patent_javabean {
	private String table_name;
	private String table;
	public Patent_javabean() {
		this.table_name = "r_patent";
		this.table = "5";
	}
	// TODO
	public ArrayList<Map<String, String>> getList() {
    	...
    	String sql = "select a.isAwarded, a.id,a.leader_id, a.title, a.pass, a.number,a.date_public,  substring(a.date_commit, 1, 10) as date_commit, u.name, t.name as type " +
    ...
    public ArrayList<Map<String, String>> getList(String user_id){
		Calendar cal = Calendar.getInstance(); 
		int currentYear = cal.get(Calendar.YEAR);
    	String sql = "select a.isAwarded, a.id,a.leader_id, a.title, a.pass, a.number,a.date_public,  " +
	...
	public ArrayList<Map<String, String>> getList(
    	...
    	String sql = "";
    	String sqlC = "select a.isAwarded, a.id,a.leader_id, a.title, a.pass, a.number,a.date_public, " +
    			"substring(a.date_commit, 1, 10) as date_commit, u.name, t.name as type ";
    	...
    	String date_apply = mapRange.get("date_apply");
    	String date_apply_2 = mapRange.get("date_apply_2");
    	String date_public = mapRange.get("date_public");
    	String date_public_2 = mapRange.get("date_public_2");
		...
		if (date_apply != null && !date_apply.equals("")) {
			sqlW2 += "and date_apply>='"+date_apply+"' ";
		}
		if (date_public != null && !date_public.equals("")) {
			sqlW2 += "and date_public>='"+date_public+"' ";
		}
		...
		if (date_apply_2 != null && !date_apply_2.equals("")) {
			sqlW2 += "and date_apply<='"+date_apply_2+"' ";
		}
		if (date_public_2 != null && !date_public_2.equals("")) {
			sqlW2 += "and date_public<='"+date_public_2+"' ";
		}
