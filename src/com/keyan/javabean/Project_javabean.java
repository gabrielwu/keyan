...
public class Project_javabean {
	private String table_name;
	private String table;
	public Project_javabean() {
		this.table_name = "r_project";
		this.table = "2";
	}
	public ArrayList<Map<String, String>> getList() {
		Calendar cal = Calendar.getInstance(); 
		int currentYear = cal.get(Calendar.YEAR);
    	String sql = "select a.isAwarded, a.id,a.leader_id,a.status, a.title, a.pass, a.date1,a.date2,  substring(a.date_commit, 1, 10) as date_commit, u.name, t.name as type " +
    ...
    public ArrayList<Map<String, String>> getList(String user_id){
		Calendar cal = Calendar.getInstance(); 
		int currentYear = cal.get(Calendar.YEAR);
    	String sql = "select a.isAwarded, a.id,a.leader_id,a.status, a.title, a.pass, a.date1,a.date2,  " +
	...
	public ArrayList<Map<String, String>> getList(
    	...
    	String sql = "";
    	String sqlC = "select a.isAwarded, a.id,a.leader_id,a.status, a.title, a.pass, a.date1,a.date2, " +
    			"substring(a.date_commit, 1, 10) as date_commit, u.name, t.name as type ";
    	...
    	String date1 = mapRange.get("date1");
    	String date1_2 = mapRange.get("date1_2");
    	String date2 = mapRange.get("date2");
    	String date2_2 = mapRange.get("date2_2");
		...
		if (date1 != null && !date1.equals("")) {
			sqlW2 += "and date1>='"+date1+"' ";
		}
		if (date2 != null && !date2.equals("")) {
			sqlW2 += "and date2>='"+date2+"' ";
		}
		...
		if (date1_2 != null && !date1_2.equals("")) {
			sqlW2 += "and date1<='"+date1_2+"' ";
		}
		if (date2_2 != null && !date2_2.equals("")) {
			sqlW2 += "and date2<='"+date2_2+"' ";
		}
