...
<html>
  ...
  <body>
     <div class="box_1">
        ...
        <div id="search_div" >
        <form id="search_form" action="softwareList.do?f=0&q=<%=q %>" onsubmit="s_check()" method="post" >
        ...
        <table id="search_tb">
            ...
            <tr>
                ...
                <td>发表日期</td>
                <td class="left" colspan="1">
                    <input name="s_date_publish" class="date sInput" readonly="readonly" id="s_date_publish" value="<%=sMapRange.get("date_publish") %>" />-
                    <input name="s_date_publish_2" class="date sInput" readonly="readonly" id="s_date_publish_2" value="<%=sMapRange.get("date_publish_2") %>" />
                </td>
            </tr>
            <tr>
                <td>授权日期</td>
                <td class="left" colspan="1">
                    <input name="s_date_authorized" class="date sInput" readonly="readonly" id="s_date_authorized" value="<%=sMapRange.get("date_authorized") %>" />-
                	<input name="s_date_authorized_2" class="date sInput" readonly="readonly" id="s_date_authorized_2" value="<%=sMapRange.get("date_authorized_2") %>" />
                </td>
                <td>类型</td>
            ...
            <tr id="tr_c">
                ...
                <td colspan="2">
                    ...
                    <input class="button" value="导出" type="button" id="btn_s_export" onclick="exportList('software')" />
                </td>
            </tr>
        </table> 
        </form>
