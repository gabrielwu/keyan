...
<html>
  ...
  <body>
    <div class="box_3">
    	<div class="div_title"><h4>软件著作权详情</h4></div>
        ...
        <table id="tb_view">
            ...
            <tr>
                <th>授权日期</th>
                <td><%=data.get("date_authorized")%></td>
            </tr>
            <tr>
                <th>著作权类型</th>
                <td><%=data.get("type")%></td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="button" onclick="javascript:award('6','<%=data.get("id") %>', 't')" value="奖励"/>
                    <input type="button" onclick="javascript:award('6','<%=data.get("id") %>', 'f')" value="未奖励"/>
                </td>
            </tr>
            <% } %>
        </table>
