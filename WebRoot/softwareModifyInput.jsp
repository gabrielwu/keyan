...
<html>
  ...
  <body>
    <div class="box_2">
	    <div class="div_title"><h4>修改软件著作</h4></div>
	    <input id="id" type="hidden" value="<%=data.get("id") %>"/>
	    <table id="table_input_2">
			<tr>
			    <td colspan="2">软件著作名称:<span id="msg_" class='msg_common'></span><br />
			        ...
			        <table>
			            ...
			            <tr>
			                <td>发表日期<span class='msg_format'>(格式:yyyy-mm)</span>:<span id="msg_" class='msg_common'></span><br />
			                    <input readonly="readonly" value="<%=data.get("date_publish") %>"  class="date" id="date_publish" type="text" />
			                </td>
			            </tr>
  		                <tr class="">
  		                    <td>2013类型:<br />
			        ...
			        <table>
			            <tr>
			                <td>授权日期:<span class='msg_format'>(格式:yyyy-mm)</span>:<span id="msg_" class='msg_common'></span><br />
			                    <input readonly="readonly" value="<%=data.get("date_authorized") %>" class="date" id="date_authorized" type="text" />
			                </td>
			            </tr>
