	            ...
	            <td colspan="2">
			        ...
			        <table id="table_member" class="table_member">
			            ...
			            <tr class="tr_member" id="tr_member_<%=i %>">
			                ...
			                <% 
			                	String memberAYears[] = map.get("a_percent").split(","); 
			                	for (String a_percent: memberAYears) {
				            %>
				                <td class="td_year_a_input"><input value="<%=a_percent%>" class="a_percent" id="a_percent_1" type="text" /></td>
			                <% } %>
			                <td>
			                <% if (i > 1){ %>
			                <a class="op" href="javascript:delMemberProject(<%=i %>)">删除</a>
			                <% } else if (i == 1) { %>
			                <a class="op" href="javascript:addMemberProject()">添加</a>
			                <% } else { %><a class="op" ></a>
			                <% } %></td>
			                <td><span class="msg_common" id="msg_common_1"></span></td>
			            </tr>
