...
<html>
  ...
  <body>
      <div class="box_2">
          <div class="div_title"><h4>提交奖项</h4></div>
                      ...
                      <table>
  		                    ...
  		                    <tr>
  		                        <td>获奖日期<span class='msg_format'>(格式:yyyy-mm)</span>:<span id="msg_" class='msg_common'></span><br />
  		                            <input readonly="readonly" class="date" id="date" type="text" />
  		                        </td>
  		                    </tr>
  		                    <tr class="">
  		                        <td>2013类型:<br />
    ...
    var memberI = 1;
    $(function() {
  	  var a_value = $("#type_id").children('option:selected').attr("title");
  	  $("#a_value").val(a_value);
