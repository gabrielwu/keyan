...
<html>
  ...
  <body>
    <div class="box_2">
	    <div class="div_title"><h4>提交著作</h4></div>
			        ...
			        <table>
			            ...
			            <tr>
			                <td>出版日期<span class='msg_format'>(格式:yyyy-mm)</span>:<span id="msg_" class='msg_common'></span><br />
			                    <input readonly="readonly" class="date" id="date_press" type="text" />
			                </td>
			            </tr>
			            <tr>
			        ...
			        <table>
			            ...
			            <tr>
			                <td>撰写字数<span class='msg_format'>(千字)</span>:<span id="msg_" class='msg_common'></span><br />
			                    <input class="" id="words_count" type="text" />
			                </td>
			            </tr>
  		                <tr class="">
  		                    <td>2013类型:<br />
