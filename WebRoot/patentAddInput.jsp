...
<html>
  ...
  <body>
    <div class="box_2">
	    <div class="div_title"><h4>提交专利</h4></div>
			        ...
			        <table>
			            ...
			            <tr>
			                <td>申请号:<span id="msg_" class='msg_common'></span><br />
			                    <input id="number_apply" type="text" />
			                </td>
			            </tr>
			            <tr>
			                <td>公开号:<span id="msg_" class='msg_common'></span><br />
			                    <input id="number_public" type="text" />
			                </td>
			            </tr>
  		                <tr class="">
  		                    <td>2013类型:<br />
			        ...
			        <table>
			            <tr>
			                <td>申请日期<span class='msg_format'>(格式:yyyy-mm)</span>:<span id="msg_" class='msg_common'></span><br />
			                    <input readonly="readonly" class="date" id="date_apply" type="text" />
			                </td>
			            </tr>
			            <tr>
			                <td>公开日期<span class='msg_format'>(格式:yyyy-mm)</span>:<span id="msg_" class='msg_common'></span><br />
			                    <input readonly="readonly" class="date" id="date_public" type="text" />
			                </td>
			            </tr>
