...
<html>
  ...
  <body>
    <div class="box_3">
    	<div class="div_title"><h4>奖项详情</h4></div>
        ...
        <table id="tb_view">
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="button" onclick="javascript:award('4','<%=data.get("id") %>', 't')" value="奖励"/>
                    <input type="button" onclick="javascript:award('4','<%=data.get("id") %>', 'f')" value="未奖励"/>
                </td>
            </tr>
            <% } %>
        </table>
