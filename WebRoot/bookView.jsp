...
<html>
  ...
  <body>
    <div class="box_3">
    	<div class="div_title"><h4>著作详情</h4></div>
        ...
        <table id="tb_view">
            ...
            <tr>
                <th>出版时间</th>
                <td><%=data.get("date_press")%></td>
            </tr>
            <tr>
                <th>出版社</th>
                <td><%=data.get("press")%></td>
            </tr>
            <tr>
                <th>著作类型</th>
                <td><%=data.get("type")%></td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="button" onclick="javascript:award('3','<%=data.get("id") %>', 't')" value="奖励"/>
                    <input type="button" onclick="javascript:award('3','<%=data.get("id") %>', 'f')" value="未奖励"/>
                </td>
            </tr>
            <% } %>
        </table>
